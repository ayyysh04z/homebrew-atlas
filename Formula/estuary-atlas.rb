...
class EstuaryAtlas < Formula
  ...
  version "0.1.12"
  url "https://github.com/ayyysh04z/estuary-atlas/releases/download/v0.1.12/estuary-atlas-v0.1.12.tar.gz"
  sha256 "f7b3ef07aab8c0e2a64436c2ae6b87bd8e5db2a16eb8f07547180d6b9e23af32"
  # ────────────────────────────────────────────────────────────────────────────
